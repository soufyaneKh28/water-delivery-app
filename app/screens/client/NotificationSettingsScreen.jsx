  ...
  const handleSettingChange = async (key, value) => {
    try {
      ...
      const tags = {
        ...
        notifications_promotions: value ? 'enabled' : 'disabled',
  ...
  const requestNotificationPermission = async () => {
    try {
      ...
      if (permission) {
        ...
        await notificationService.registerUser(user.id, user.user_metadata?.role || 'client');
        Alert.alert('Success', 'Notification permission granted! You will now receive order updates.');
        await loadNotificationStatus();
      } else {
        Alert.alert(
          'Permission Denied', 
          'To receive order updates, please enable notifications in your device settings and try again.',
          [
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
                ...
                {notificationStatus.permissionDenied ? (
                  <View style={styles.permissionDeniedContainer}>
                    <CustomText style={styles.permissionDeniedText}>
                      Notifications are disabled in your device settings. Please enable them to receive order updates.
                    </CustomText>
                    <PrimaryButton
                      title="Open Settings"
                      onPress={() => {
        ...
        <View style={styles.section}>
          ...
          {renderNotificationItem(
            'New Orders',
            'Get notified when you place a new order',
            'newOrders',
            settings.newOrders
          )}
        ...
        {/* Information */}
        <View style={styles.section}>
          <CustomText style={styles.sectionTitle}>About Notifications</CustomText>
          <View style={styles.infoCard}>
            <CustomText style={styles.infoText}>
              • You'll receive notifications for new orders and status updates
            </CustomText>
            <CustomText style={styles.infoText}>
              • Notifications help you stay updated on your water delivery orders
            </CustomText>
            <CustomText style={styles.infoText}>
